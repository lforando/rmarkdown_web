...
##### *Missing data doesn't always indicate that there isn't a problem, it just means we are going about it the wrong way.*
 ...
 ![](https://media.istockphoto.com/vectors/black-pregnant-woman-with-nature-and-leaves-background-concept-vector-vector-id1171915511?k=6&m=1171915511&s=612x612&w=0&h=E2W2pwjc3buDMEPO9o88t3RgGLEm-5RM4p4X1Lse_gU=){size=15%}
